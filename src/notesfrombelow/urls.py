...
urlpatterns = [
    ...
    path('articles/<slug:category>/<int:page>', notesfrombelow.views.articles_list, name='articles'),
    path('articles', notesfrombelow.views.articles_list, {'page': 1, 'category': 'all'}, name='articles_main'),
    ...
    #path('articles/<slug:slug>', journal.views.CategoryView.as_view(), name='category'),
